                    ...
                    <AnimatePresence>
                      {activeDropdown === link.href && (
                        <motion.div
                          ...
                          className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-[600px] bg-gray-800/98 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden p-3"
                        >
                          <div className="grid grid-cols-2 gap-3">
                            {link.dropdown.map((item, idx) => (
                              <Link
                                key={idx}
                                href={item.href}
                                className="group relative p-5 rounded-xl bg-gray-900/50 hover:bg-gradient-to-br hover:from-blue-500/20 hover:to-purple-500/20 border border-white/5 hover:border-white/10 transition-all duration-300"
                              >
                                {/* 内容 */}
                                <div className="relative">
                                  {/* 图标 */}
