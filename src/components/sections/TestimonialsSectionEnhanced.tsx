  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content: 'XYVN 团队的专业能力令人印象深刻。他们不仅按时交付了高质量的电商平台，还提供了许多创新的解决方案。转化率提升了 230%，这个成果超出了我们的预期。',
      project: '智慧零售电商平台',
      tags: ['电商平台', '高转化率', '创新方案'],
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      content: '安全性是金融产品的重中之重，XYVN 在这方面做得非常出色。多重身份验证、数据加密等安全措施都很到位。产品上线后获得了 AAA 安全等级认证。',
      project: '金融科技 APP',
