                    ...
                    <AnimatePresence>
                      {activeDropdown === link.href && (
                        <motion.div
                          ...
                          className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-[600px] bg-gray-900/98 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden p-3"
                        >
